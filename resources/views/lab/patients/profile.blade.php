...
<div class="container">
                        ...
                        <div class="col-11 ">
                            <div class="row justify-content-center">
                                <div class="mb-4 col-8 col-md-3 ">
                                    ...
                                    <a href="{{ URL('/lab/patients/chat', $patient[0]->id) }}" class="btn btn-primary primary_color primary_color_border float-end mt-2">Chat</a>
                                    <form class="" action="{{url('/lab/patients/remove')}}" method="POST">
                                        @csrf
                                        @method('DELETE')   
    ...
    <div class="row justify-content-center mb-5">
        <div class="row justify-content-center">
            <a href="{{ route('lab.index.tests',  $patient[0]->id) }}" class="frst col-6 col-lg-3 d-flex flex-column text-white text-decoration-none justify-content-center align-items-center" style="aspect-ratio: 1 / 1">
                <img class="mb-2" src="{{ URL('/storage/new/test-tube.png') }}" style="width: 30%">
                <b>Tests</b>
            </a>
            <a href="{{ URL('/lab/radiology/'.$patient[0]->id) }}" class="scnd icons_child col-6 col-lg-3 d-flex flex-column text-white text-decoration-none justify-content-center align-items-center" style="aspect-ratio: 1 / 1">
