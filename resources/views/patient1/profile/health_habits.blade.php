    ...
    <div class="col-11 mb-4">
        <form action=" {{url('/patient/profile/health/edit')}}" >
            ...
            <div class="col">
                ...
                <div class="clearfix">
                    <button name="health_habits_patient_save_button" type="submit" class="btn btn-primary float-end">Save</button>
                </div>
            </div>
        </form> 
    </div>
    ...
    <div class="col-11 mb-4">
        <form action="{{url('/patient/profile/health/mental')}}">
            ...
            <div class="col">
                ...
                <div class="clearfix">
                    <button name="family_health_patient_save_button" type="submit" class="btn btn-primary float-end">Save</button>
                </div>
            </div>
        </form> 
    </div>
