        ...
        <div class="col-md-12">
            <div class="pb-3 p-0 card border-0 rounded-0">
                ...
                <div class="card-header border-1 bg-white ps-3 fs-4">
                    <form class="row g-3" action="{{ URL('/patient/tests/search') }}" method="GET">
                      @csrf
                      ...
                      <div class="col-auto">
                        ...
                        <a href="{{ URL('/patient/tests/index') }}" class="btn btn-primary primary_color border-0 mb-3" >All Tests</a>
                      </div>
                    </form>
                  </div>
