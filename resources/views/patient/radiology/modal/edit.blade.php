<form action="{{url('/patient/radiology/update/'.$radiology->id) }}" method="post" enctype="multipart/form-data">
    @csrf
    @method('POST')
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit radiology</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text"  value="{{$radiology->radiology}}" class="form-control" id="allergy" name="radiology_name">
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" value="{{$radiology->lab_name}}" class="form-control" id="lab" name="lab_name">
                      </div>
                      <div class="mb-3">
                          <label for="recipient-name" class="col-form-label">Doctor</label>
                          <input type="text"  value="{{$radiology->doctor_name}}" class="form-control" id="doctor" name="doctor_name">
