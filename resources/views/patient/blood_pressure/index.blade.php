        ...
        <div class="col-md-12">
            <div class="pb-3 p-0 card border-0 rounded-0">
                ...
                <div class="card-header border-1 primary_color_border bg-white mb-2 p-0 fs-5">
                    <a href="{{ URL('/patient/readings/bs/index') }}" class="me-4 mb-0 float-end p-1 text-decoration-none text-dark fs-6 ">Blood Sugar</a>
                    <a href="{{ URL('/patient/readings') }}" class="me-3 float-end p-1 ps-3 pe-3  text-decoration-none text-white fs-6 primary_color">Blood Pressure</a>
                </div>
                ...
                <div class="mt-4 row justify-content-center">
                    <div class="col-11 ">
                        <div class="row justify-content-center">
                            ...
                            <form class="" action="{{url('/patient/readings/bp/delete')}}" method="POST">
                                @csrf
                                @method('DELETE')   
                            ...
                            <div class="d-flex flex-row justify-content-end p-0">
                                ...
                                <div class="modal fade" id="add_modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                        ...
                                        <form id="" method="POST" action="{{ URL('/patient/readings/bp/create') }}">
                                            @csrf
                                            @method("POST")
                                            <div class="modal-body">
                                                <div class="row">
                                                ...
                                                <div class="input-group">
                                                    <input type="number" class="form-control" name="reading_top"> 
                                                    <span class="input-group-text" id="inputGroup-sizing-sm">Over</span>
                                                    <input type="number" class="form-control" name="reading_bottom">
                                                </div>
                                            </div>
                                                <div class="modal-footer">
