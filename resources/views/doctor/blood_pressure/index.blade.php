...
<div class="container">
    <div class="row justify-content-center mb-5">
        <div class="col-md-12">
            <div class="pb-3 p-0 card border-0">
                ...
                <div class="card-header border-1 primary_color_border bg-white mb-4 p-0 fs-5">
                    <a href="{{ URL('/doctor/readings/bs/index', $patient_id) }}" class="me-4 mb-0 float-end p-1 text-decoration-none text-dark fs-6 ">Blood Sugar</a>
                    <a href="{{ URL('/doctor/readings', $patient_id) }}" class="me-3 float-end p-1 ps-3 pe-3  text-decoration-none text-white fs-6 primary_color">Blood Pressure</a>
                </div>
