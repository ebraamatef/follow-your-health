        ...
        <div class="pb-3 card border-0 rounded-0">
          <div class="card-header border-1 primary_color mb-4 fs-4 d-flex align-items-center border-0 rounded-0">
            ...
            <div class="card-body pb-0">
                  ...
                  <div class="gap-3 row justify-content-center mb-4">
                      {{-- {{ dd($doctors) }} --}}
                        @foreach($doctors as $doctor)
                          <div class="p-0 card" style="width: 13rem;">
                              <div class="card-header">
                              <img src="@if($doctor->image == NULL) {{ URL('storage/doctor.png') }}@else{{ URL('storage/doctors/' . $doctor->user_id . '/' . $doctor->image) }}@endif" class="card-img-top">
                              </div>
