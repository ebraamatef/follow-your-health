                ...
                <div class="p-0 card-body">
                    <div class="mb-4 row justify-content-center">
                        <div class="col-11 p-0">
                            <div class="row justify-content-center">
                                <form class="row g-3" action="{{url('/doctor/visit/iframe/search/radiology')}}">
                                    <div class="col-10 col-sm-8 col-md-8">
                                        <div class="d-flex">
                                            ...
                                            <div class="col-auto">
                                                <button name="search_button_visits_patient" type="submit" class="btn btn-primary primary_color primary_color_border border-0 mb-3">Search</button>
                                            </div>
                                        </div>
                                        <a href="{{ URL('/doctor/visit/iframe/radiology', $patient_id) }}" class="btn btn-primary primary_color primary_color_border border-0 mb-3 me-3" >All Radiology</a>
                                    </div> 
                                </form>
                            </div>
                        </div>
